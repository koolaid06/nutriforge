...
export default function Dashboard({ profile, weightLog, onLogoClick }) {
  ...
  const suggestion   = getAdaptiveSuggestion({ weightLog, goal: profile?.goal, targetCalories: targets?.targetCalories })
  ...
  return (
    <Layout title="DASHBOARD" profile={profileWithStreak} onLogoClick={onLogoClick}>
      <div className="w-full max-w-[1400px] mx-auto px-3 md:px-6 flex flex-col gap-4 lg:gap-6">
        ...
        {/* Row 1: Phase (wide) + Discipline Score */}
        ...
        {/* Row 2: Intake ring + Macro breakdown */}
